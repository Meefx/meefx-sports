"""
Django settings for meefx_sports project.
...
SECRET_KEY = 'django-insecure-2j8yp^=t5nj=l#)#$9b$fj=y1xdc)89&35$rbj6qlqk(s9@=dx'
...
ROOT_URLCONF = 'meefx_sports.urls'
...
WSGI_APPLICATION = 'meefx_sports.wsgi.application'
